 ...
 */
public class YCHandlerAdapter {
    public boolean supports(Object handler){ return (handler instanceof YCHandlerMapping);}


    YCModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        YCHandlerMapping handlerMapping = (YCHandlerMapping)handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == YCModelAndView.class;
        if(isModelAndView){
            return (YCModelAndView) result;
        }
        return null;
    }
