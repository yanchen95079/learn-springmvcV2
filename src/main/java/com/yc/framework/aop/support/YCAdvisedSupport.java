package com.yc.framework.aop.support;
 ...
 */
public class YCAdvisedSupport {

    private Class<?> targetClass;

    private Object target;

    private YCAopConfig config;

    private Pattern pointCutClassPattern;

    private transient Map<Method, List<Object>> methodCache;

    public YCAdvisedSupport(YCAopConfig config) {
        this.config = config;
    }
            ...
            for (Method m : this.targetClass.getMethods()) {
                ...
                if(matcher.matches()){
                    ...
                    if(!(null == config.getAspectBefore() || "".equals(config.getAspectBefore()))) {
                        //创建一个Advivce
                        advices.add(new YCMethodBeforeAdviceInterceptor(aspectMethods.get(config.getAspectBefore()),aspectClass.newInstance()));
                    }
                    //after
                    ...
                    if(!(null == config.getAspectAfterThrow() || "".equals(config.getAspectAfterThrow()))) {
                        //创建一个Advivce
                        YCAfterThrowingAdviceInterceptor throwingAdvice =
                        new YCAfterThrowingAdviceInterceptor(
